...
- Yearn's security team has decided to award the disclosing security researcher with the maximum bounty reward of $200,000.

## Background

A security researcher contacts Yearn's security team through its vulnerability disclosure process about a possible exploit that can lead to significant loss of user funds.
...
**June 29, 2021, 19:20 (UTC):** Initial contact by a security researcher.
